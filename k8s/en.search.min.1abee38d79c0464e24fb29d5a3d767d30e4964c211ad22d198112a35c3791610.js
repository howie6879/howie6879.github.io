...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/k8s/flexsearch.min.js');loadScript('/k8s/en.search-data.min.19db86472753badc58260833b0ccf8426eb259a1daa5b3e41d60342f7920bb1f.js',function(){input.required=false;search();});}
