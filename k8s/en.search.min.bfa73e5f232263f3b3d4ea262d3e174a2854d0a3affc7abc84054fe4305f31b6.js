...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/k8s/flexsearch.min.js');loadScript('/k8s/en.search-data.min.2ddce2616b36bf4babfb65b770f439b20ab7cc4a833e96cb252c591d3b2d1710.js',function(){input.required=false;search();});}
