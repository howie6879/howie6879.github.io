...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/k8s/flexsearch.min.js');loadScript('/k8s/en.search-data.min.005b4c6903565de02afbb12c8812922f2468ffb4d935f1a5b5b64fa59f0e13a4.js',function(){input.required=false;search();});}
