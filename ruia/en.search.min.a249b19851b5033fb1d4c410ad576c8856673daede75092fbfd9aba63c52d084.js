...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/ruia/flexsearch.min.js');loadScript('/ruia/en.search-data.min.adfeefa0cb9eaa8e9ef65392a7842f662589a8898186dc0df3581c593ceb142c.js',function(){input.required=false;search();});}
