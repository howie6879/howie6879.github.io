...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/ruia/flexsearch.min.js');loadScript('/ruia/en.search-data.min.65747a96a96a4f1e0a630ff849d4a99fd92726724a596496a318c9c5f987c0d7.js',function(){input.required=false;search();});}
