---
title: "k8s学习之路.基础.[03.容器持久化存储]"
date: 2021-03-04T22:35:47+08:00
lastmod: 2021-03-04T22:35:47+08:00
keywords: []
description: "容器持久化存储"
tags: ["k8s学习之路"]
categories: ["云原生","教程"]
author: "howie.hu"
image: /images/thumbs/h_61.png
---

容器的本质是进程，对于进程，`Linux`系统有进程组的概念来将其组织在一起。在`k8s`里面，使用`Pod`这个逻辑概念来维护容器间的关系。

![图来自极客时间](https://cdn.jsdelivr.net/gh/howie6879/oss/uPic/16c095d6efb8d8c226ad9b098689f306.png)
...
![image-20210305144115418](https://cdn.jsdelivr.net/gh/howie6879/oss/uPic/image-20210305144115418.png)
...
![image-20210305175203591](https://cdn.jsdelivr.net/gh/howie6879/oss/uPic/image-20210305175203591.png)
...
![image-20210305213129142](https://cdn.jsdelivr.net/gh/howie6879/oss/uPic/image-20210305213129142.png)
