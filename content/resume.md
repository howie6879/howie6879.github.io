...
- 对LinkedIn近一千万公司数据进行爬取（基于pyspider的分布式爬虫）：对数据进行分析，构建客户画像
- 公司名搜索服务：通过用户输入公司名，自动返回公司主页、公司地址、邮箱、社交主页等信息，解决客服的信息获取痛点。
- 后端接口编写（Django）

### 旭日集团实习 （2015年7月 ~ 2015年9月）

大二的实习经历，主要工作内容如下：

- 任职后端工程师，主要负责真维斯网站vip模块
- 作为组长，带领一起实习的同事把控项目，最终项目如期完成
...
- 2020蓝桥实验楼年度优秀作者
- 专利：CN110059189A_一种游戏平台消息的分类系统及方法，目前处于实质审查阶段

### 奖项

- 2016年全国计算机设计大赛服务外包全国一等奖：浙江大学命题的互联网新闻推荐系统
