...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/ml_book/flexsearch.min.js');loadScript('/ml_book/en.search-data.min.56d6d7acda54dc7c7204efbf06b15d4921787a6f1993cae160f099817c78a75a.js',function(){input.required=false;search();});}
