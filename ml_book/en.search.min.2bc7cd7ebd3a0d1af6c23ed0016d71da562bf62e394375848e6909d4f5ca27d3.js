...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/k8s/flexsearch.min.js');loadScript('/k8s/en.search-data.min.3c012dc9af2591c22073fff93be99c4fe86bf8ef70273890314c54d47112413d.js',function(){input.required=false;search();});}
